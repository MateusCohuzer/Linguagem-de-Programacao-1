...
class Processamento {
    ...
    int somatoriaVetorInt(int[] vetor) {
        int soma = 0;
    ...
    double escolheSe(double antigo, double novo, int escolha) {
    ...
    boolean escolheSeBool(double antigo, double novo, int escolha) {
    ...
    String limparEspacos(String frase) {
